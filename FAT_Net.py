...
class FAT_Net(nn.Module):
    ...
    def forward(self, x):
        ...
        h2 = feature_cnn.register_hook(self.activations_hook2)
        ...
        h1 = feature_tf.register_hook(self.activations_hook1)
        feature_cat = torch.cat((feature_cnn, feature_tf), dim=1)
        feature_att = self.se(feature_cat)
        feature_out = self.conv2d(feature_att)
        h = feature_out.register_hook(self.activations_hook)
        h3 = e3.register_hook(self.activations_hook3)
        h4 = e2.register_hook(self.activations_hook4)
        h5 = e1.register_hook(self.activations_hook5)
        for i in range(2):
            e3 = self.FAM3[i](e3)
        for i in range(4):
            e2 = self.FAM2[i](e2)
        ...
        h6 = e3.register_hook(self.activations_hook6)
        h7 = e2.register_hook(self.activations_hook7)
        h8 = e1.register_hook(self.activations_hook8)
